    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table">
                 ...
                 * ngc lại là bảng đang rỗng*/
                if($result->num_rows >0){
                    /*
                     * Sử dụng $result ->fetch->assoc() để lấy về từng dòng bản ghi trong bẳng
                ...
                <td>
                    ...
                    <p><a href="edit.php?id=<?php echo $row["id"]?>" class="btn btn-danger">Xóa nhân viên</a></p>
